<form id="insure-add" class="easyui-form">
	<table cellpadding="5" class="formLayout">
		<tr>
			...
			<td class="uppercase">
				<input class="easyui-textbox" type="text" name="carNum" data-options="required:true,validType:'length[1,20]'" readonly></input>
				<a href="#" class="easyui-linkbutton" iconCls="icon-advancedsettings" plain="true" onclick="javascript:CommonUtil.carSelect('insure-add')"></a>
			</td>
			<td class="formLayoutTit">建运号:</td>
			<td class="uppercase">
				<input class="easyui-textbox" type="text" name="operateNum" data-options="required:true,validType:'length[1,20]'" readonly></input>
				<a href="#" class="easyui-linkbutton" iconCls="icon-advancedsettings" plain="true" onclick="javascript:CommonUtil.carSelect('insure-add')"></a>
			</td>
		</tr>
		<tr>
			...
			<td>
				<input class="easyui-textbox" type="text" name="ownerName" data-options="validType:'length[1,20]'" readonly></input>
				<a href="#" class="easyui-linkbutton" iconCls="icon-advancedsettings" plain="true" onclick="javascript:CommonUtil.carSelect('insure-add')"></a>
			</td>
			<td class="formLayoutTit">联系方式:</td>
			<td>
				<input class="easyui-textbox" type="text" name="ownerPhone" data-options="validType:'Mobile'" readonly></input>
				<a href="#" class="easyui-linkbutton" iconCls="icon-advancedsettings" plain="true" onclick="javascript:CommonUtil.carSelect('insure-add')"></a>
			</td>
		</tr>
		<tr>
