<div class="easyui-layout" style="height:100%;">
			...
			<table style="margin:15px auto;min-width:915px;">
				<tr style="height:45px;">
					...
					<td width='200px' align="left">
						<select id="manage-deadline" class="easyui-combobox" name="deadline" data-options="editable:false" style="width:135px;">
	...
	<div id="manage-content" region="center" title="列表区">
		<table id="manage-datagrid" class="easyui-datagrid" style="height:100%"
			...
			<thead>
				<tr>
					...
					<th field="endDate" width="80" data-options="sortable:true,styler:ManageManage.dateRowStyle,formatter: ManageManage.formatRowDate">管理费止期</th>
		...
		<div id="manage-toolbar">
			...
			<a href="#" class="easyui-linkbutton" iconCls="icon-redo" plain="true" onclick="javascript:ManageManage.importData()">数据导入</a>
